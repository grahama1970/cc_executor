#!/usr/bin/env python3
"""
Complex Stress Test Runner - Executes the runner from the prompt file.
"""
import sys
import subprocess
from pathlib import Path

PROMPT_PATH = Path("/home/graham/workspace/experiments/cc_executor/tests/stress/prompts/complex_stress_tests_prompt.md")
...
def extract_and_run_code():
    ...
    temp_file = Path("/tmp/complex_stress_test_runner.py")
